...
import { Menu, Home as HomeIcon, Users, CalendarClock, Stethoscope, FileBarChart2 } from "lucide-react";
    ...
    <div className="min-h-screen grid" style={{ gridTemplateColumns: sidebarWidth }}>
      <aside
        className={`sticky top-0 h-screen overflow-y-auto transition-all duration-300 ${
          open ? "border-r border-white/5 shadow-xl shadow-black/30" : ""
        }`}
      >
        <div className="h-16 flex items-center px-4 text-white font-semibold text-xl">
          HealthTrack
        </div>
